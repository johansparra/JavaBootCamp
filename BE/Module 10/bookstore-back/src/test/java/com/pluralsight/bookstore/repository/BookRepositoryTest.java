...
/*    @Test(expected = Exception.class)
    ...
    public void shouldFailCreatingABookWithLowUnitCostTitle() {
        bookRepository.create(new Book("isbn", "a title", 12F, 123, Language.ENGLISH, new Date(), "imageURL", "description"));
    }

    @Test(expected = Exception.class)
    @InSequence(13)
    public void shouldFailCreatingABookWithNullISBN() {
        bookRepository.create(new Book(null, "a title", 12F, 123, Language.ENGLISH, new Date(), "imageURL", "description"));
    }*/
